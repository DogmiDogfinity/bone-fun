export const idlFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    get_dogs_info: IDL.Func([IDL.Principal], [IDL.Vec(DogContextOut)], ['query']),
    ...
    get_record_index: IDL.Func([IDL.Nat64, IDL.Nat64], [IDL.Vec(IDL.Tuple(IDL.Nat64, MRecord))], ['query']),
    get_record_rev: IDL.Func([IDL.Nat64, IDL.Nat64], [IDL.Vec(IDL.Tuple(IDL.Nat64, MRecord))], ['query']),
    ...
    top_alliance: IDL.Func(
      [],
      [IDL.Vec(IDL.Tuple(IDL.Text, IDL.Nat64, IDL.Nat64, IDL.Nat64, IDL.Nat64, IDL.Nat64, IDL.Nat))],
      ['query'],
    ),
    top_user: IDL.Func(
      [],
      [IDL.Vec(IDL.Tuple(IDL.Principal, IDL.Nat64, IDL.Nat64, IDL.Nat64, IDL.Nat64, IDL.Nat))],
      ['query'],
    ),
