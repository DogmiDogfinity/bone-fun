...
export type DogLevel = { SilverDog: null } | { GoldDog: null } | { CopperDog: null } | { DiamondDog: null };
...
export type MiningState = { STOP: null } | { ACTIVITY: null };
export type MiningType = { POOL: null } | { ALONE: null };
...
export type Result_3 = { Ok: [string, bigint, bigint] } | { Err: string };
export interface VerifyDogHash {
  dog_hash: DogHash;
  create_time: bigint;
}
export interface _SERVICE {
  ...
  top_alliance: ActorMethod<[], Array<[string, bigint, bigint, bigint, bigint, bigint, bigint]>>;
  top_user: ActorMethod<[], Array<[Principal, bigint, bigint, bigint, bigint, bigint]>>;
